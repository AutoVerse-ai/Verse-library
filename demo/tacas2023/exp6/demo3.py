...
if __name__ == "__main__":
    ...
    scenario.add_agent(CarAgent('car1', file_name=input_code_name, initial_state=[[0, -0.5, 0, 1.0], [0.01, 0.5, 0, 1.0]], initial_mode=(VehicleMode.Normal, TrackMode.T1)))
    scenario.add_agent(NPCAgent('car2', initial_state=[[15, -0.3, 0, 0.5], [15, 0.3, 0, 0.5]], initial_mode=(VehicleMode.Normal, TrackMode.T1)))

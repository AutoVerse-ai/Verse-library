...
if __name__ == "__main__":
    ...
    init_h = [[10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11], [10, 11]]

    initial_set_polytope = pc.box2poly(init_h)
    ...
    print("diams")
    diams = time_step_diameter(trace, 20, 0.01)
    print(len(diams))
    print(sum(diams))
    print(diams[0])
    print(diams[-1])

    reach = reach_star(trace, 19.9 - 0.01*0.1, 20.0 + 0.01*0.1)
    print(reach['Helicopter'][0].overapprox_rectangle())

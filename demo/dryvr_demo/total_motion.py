...
if __name__ == "__main__":
    ...
    init_tm = [[-15, -14.95], [3.25, 3.3], [0, 0], [0, 0], [0, 0], [0, 0]]
    initial_set_polytope = pc.box2poly(init_tm)
    TM.set_initial(StarSet.from_polytope(initial_set_polytope),  tuple([TMMode.SlowDown]))

    scenario = Scenario()

    scenario.config.reachability_method = ReachabilityMethod.STAR_SETS
    scenario.add_agent(TM)

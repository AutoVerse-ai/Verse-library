...
deltap = -0.002; # axial position where sleeve engages with second gear(m)
...
def decisionLogic(ego: State):
    ...
    if ego.agent_mode == AgentMode.Free:
        if (ego.py >= -ego.px * 0.726542528005361) and (ego.vx * 0.5877852522924731 + ego.vy * 0.8090169943749475 > 0 and ego.trans < 8):
            output.i = ego.i + (ego.vx * 0.5877852522924731 + ego.vy * 0.8090169943749475) * (zeta + 1) * ms * mg2 / (
                        ms * (0.6545084971874737) + mg2 * (0.3454915028125263))
            output.vx = (ego.vx * (ms * 0.6545084971874737 - mg2 * zeta * 0.3454915028125263) + ego.vy * (
                        -(zeta + 1) * mg2 * 0.5877852522924731 * 0.8090169943749475)) / (
                                    ms * (0.6545084971874737) + mg2 * (0.3454915028125263))
            output.vy = (ego.vx * (-(zeta + 1) * ms * 0.5877852522924731 * 0.8090169943749475) + ego.vy * (
                        mg2 * 0.3454915028125263 - ms * zeta * 0.6545084971874737)) / (
                                    ms * (0.6545084971874737) + mg2 * (0.3454915028125263))

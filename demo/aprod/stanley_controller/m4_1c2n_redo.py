from car_agent_redo import CarAgent, NPCAgent
...
if __name__ == "__main__":
    ...
    input_code_name = os.path.join(script_dir, "controller_redo.py")
    ...
    base_l, base_u = [134, 11.5, 0, 5.0], [136, 14.5, 0, 5.0]
    ...
    scenario.set_init(
        [
            [[134, 11.5, 0, 5.0, -0.5, -np.pi/18], [136, 14.5, 0, 5, 0.5, np.pi/18]], # adding in constant noise terms
            # [init_l, init_u],

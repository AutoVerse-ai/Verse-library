...
class OtherState:
    has_priority: float; next_mode: float; assign_wait_priority: float
...
def decisionLogic(ego: State, other: OtherState):
    ...
    if ego.dist < merge_dist and ego.assign_mode == AssignMode.Assigned and other.assign_wait_priority >= 0.9:

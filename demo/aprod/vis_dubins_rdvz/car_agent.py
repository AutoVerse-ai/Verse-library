...
class CarAgent(BaseAgent):
    ...
    def TC_simulate(
        ...
        trace[0, 1:] = init
        init = np.array(init)
        timer_start = init[13] # or 5 if estimated and error states unused
        holder = init[14:] # contains id, connected_ids, assigned_id, dist, prev_sense, and cur_sense that shouldn't be touched 

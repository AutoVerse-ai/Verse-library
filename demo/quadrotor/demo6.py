...
if __name__ == "__main__":
    input_code_name = './demo/quadrotor/quadrotor_controller3.py'
    input_code_name2 = './demo/quadrotor/quadrotor_controller4.py'
    scenario = Scenario()

    path = os.path.abspath(__file__)
    path = path.replace('demo6.py', 'test.json')
    # print(path)
    ...
    init_l_1 = [9.5, 0, -0.3, 0, 0, 0]
    init_u_1 = [10, 0.5, 0.3, 0, 0, 0]
    # init_l_1 = [4.5, 0, -0.3, 0, 0, 0]
    # init_u_1 = [5, 0.5, 0.3, 0, 0, 0]
    # init_l_1 = [15, -10, -0.2, 0, -0.0, 0]
    # init_u_1 = [15.25, -9.75, 0.2, 0, -0.0, 0]
    ...
    init_l_2 = [3, 9, -0.3, 0, 0, 0]
    init_u_2 = [3.5, 9.5, 0.3, 0, 0, 0]
    # init_l_2 = [-5.5, 0, -0.3, 0, 0, 0]
    # init_u_2 = [-5.0, 0.5, 0.3, 0, 0, 0]
    # init_l_2 = [5, -10, -0.2, 0, -0.0, 0]
    # init_u_2 = [5.25, -9.75, 0.2, 0, -0.0, 0]

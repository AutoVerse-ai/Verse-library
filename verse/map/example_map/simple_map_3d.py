...
class SimpleMap1(LaneMap_3d):
    def __init__(self, box_side: dict = {}, t_v_pair: dict = {}):
        ...
        segment1 = StraightLane_3d(
            "seg0", [0, -2 * width, 0], [100, -2 * width + y_offset, 0 + z_offset], width
        )
...
class SimpleMap3(LaneMap_3d):
    def __init__(self, box_side: dict = {}, t_v_pair: dict = {}):
        ...
        segment1 = StraightLane_3d("seg1", end1, start, 5)
        end2 = get_end(end, end_tang, lens)
        segment2 = StraightLane_3d("seg2", end, end2, 5)
...
class SimpleMap4(LaneMap_3d):
    def __init__(self, box_side: dict = {}, t_v_pair: dict = {}):
        ...
        segment0 = CircularLane_3d_v1("seg0", center0, 5, n, 0, phase, True, width)
        start, start_tang, end, end_tang = segment0.get_start_end_tang()
        lens = 10
        end1 = get_end(start, -start_tang, lens)
        segment1 = StraightLane_3d("seg1", end1, start, width)
        end2 = get_end(end, end_tang, lens)
        segment2 = StraightLane_3d("seg2", end, end2, width)
        segment3 = CircularLane_3d_v2("seg3", end2, end1, -n, phase, True, 1)
        lane0 = Lane_3d("Lane0", [segment0, segment1, segment2, segment3])
        self.add_lanes([lane0])
        center1 = center0 + 2 * width * n
        segment_1_0 = CircularLane_3d_v1("seg0", center1, 5, n, 0, phase, True, width)
        ...
        segment_1_3 = CircularLane_3d_v2("seg3", end2, end1, -n, phase, True, 1)
        lane1 = Lane_3d("Lane1", [segment_1_0, segment_1_1, segment_1_2, segment_1_3])
...
class SimpleMap5(LaneMap_3d):
    def __init__(self, box_side: dict = {}, t_v_pair: dict = {}):
        ...
        segment0 = CircularLane_3d_v1("seg0", center0, radius, n, 0, phase, True, width)
        start, start_tang, end, end_tang = segment0.get_start_end_tang()
        lens = 2 * radius
        end1 = get_end(start, -start_tang, lens)
        segment1 = StraightLane_3d("seg1", end1, start, width)

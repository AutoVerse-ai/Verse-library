        ...
        while True:
            ...
            if len(self.verification_queue) > 0:
                ...
                if not self.config.parallel:
                    node = self.compute_full_reachtube_step(node, remain_time, time_step, max_height, lane_map, init_seg_length, reachability_method,run_num, past_runs, transition_graph, params)

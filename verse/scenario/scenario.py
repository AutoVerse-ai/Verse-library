...
class Scenario:
    ...
    def simulate(self, time_horizon, time_step, plotter=None, max_height=None, seed=None) -> AnalysisTree:
    ...
    def verify(self, time_horizon, time_step, ax=None, max_height=None, params={}) -> AnalysisTree:

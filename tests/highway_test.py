...
from verse.scenario.scenario import Benchmark, Scenario, ScenarioConfig
...
def highway_test():
    ...
    time_step = 0.1
    traces_sim = scenario.simulate(40, time_step)
    traces_veri = scenario.verify(40, time_step, params={"bloating_method": "GLOBAL"})

    return traces_sim, traces_veri
